...
#### Поля
- protected _close (HTMLElement) представляет собой HTML-элемент, который используется для закрытия компонента.
...
#### Поля
  ...
  - _description? (HTMLElement) представляет собой HTML-элемент, который используется для хранения описания товара или заказа.
   - image(HTMLImageElement) представляет собой HTML-элемент типа <img>, который используется для отображения изображения товара.
...
#### Поля
- _cash (HTMLButtonElement): Элемент для выбора оплаты наличными.
- _card (HTMLButtonElement): Элемент для выбора оплаты картой.
